# Count all alcohol-related crimes within 500 feet of restaurants that serve alcohol and are within 1000 feet of the Historical District:
import arcpy
import os
...
arcpy.management.SelectLayerByLocation("restaurant_layer", "WITHIN_A_DISTANCE","hist_dist_layer", "1000 feet","NEW_SELECTION" )
